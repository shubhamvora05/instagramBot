...
chromedriver_path = 'E:/python/insta follower bot/chromedriver.exe'
...
username.send_keys('shubhamvora05')
password = webdriver.find_element_by_name('password')
password.send_keys('Insta.@678')
...
hashtag_list = ['indiafact', 'startupindiaclub', 'indianstockmarkets', 'indiangkpage', 'motivationhindiquotes']
        ...
        for x in range(1, 200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    if comm_prob > 7:
                        comments += 1
                        webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[2]/button/div/svg').click()
